...
import 'package:pet_mania/pages/product_detail.dart';
          ...
          return Dismissible(
            ...
            onDismissed: (direction) {
              if (direction == DismissDirection.endToStart) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(item['name'] + " dismissed"), duration: const Duration(seconds: 1)));
              } else {
                // Then show a snackbar.
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(item['name'] + " added to carts"), duration: const Duration(seconds: 1)));
              }
                          ...
                          Row(
                            children: <Widget>[
                              ...
                              const Padding(
                                ...
                                child: Text('(\$400)', style: TextStyle(fontWeight: FontWeight.w700, fontStyle: FontStyle.italic, color: Colors.grey, decoration: TextDecoration.lineThrough)),
                              )
                            ],
                          ),
                          Row(
