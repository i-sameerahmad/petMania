...
class PetOwnerDashboard extends StatefulWidget {
  ...
  @override
  PetOwnerDashboard(
      {Key? key, required this.generalAppUser, required this.petOwner})
      : super(key: key);
...
class _PetOwnerDashboardState extends State<PetOwnerDashboard> {
  ...
  List<MyDashboardCardData> generateCardData() {
    return <MyDashboardCardData>[
      MyDashboardCardData(
          title: PETS, imgPath: "assets/images/trainerLogo.png"),
      MyDashboardCardData(
          title: VATERINARIAN, imgPath: "assets/images/veterinariansLogo.png"),
      MyDashboardCardData(
          title: BREEDER, imgPath: "assets/images/breedersLogo.png"),
      MyDashboardCardData(
          title: PETPANDA, imgPath: "assets/images/petPandaLogo.png"),
      MyDashboardCardData(
          title: ADOPTAPET, imgPath: "assets/images/adoptPetLogo.png"),
      MyDashboardCardData(
          title: BLOGSANDARTICLES,
              ...
              if (gridCardData[index].title == PETS) {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => GetStartedPage(
                              pageData:
                                  PetOwnerDashboard.getStartedWithPetPanda,
                              appUser: appUser,
                            )));
  ...
  Widget mobile(BuildContext context, appUser) {
    return CustomScrollView(
      ...
      slivers: [
        myDashboardAppBar(
            title: "Hello ${appUser['name']}!", generalAppUser: appUser),
        SliverPadding(
